...
class DarbuListas(models.Model):
    title = models.CharField("Pavadinimas", max_length=100, help_text="Pavadink šitą darbą kaip nors originaliai")
...
class DarboDuomenys(models.Model):
    ...
    suged = models.CharField("A_sugedimai", max_length=200, help_text="Automobilio sugedimai")
